...
13. [X] Add a web-viewer POI editor (Terra Draw): draw/label/persist/export pavilions, buildings, and POIs in `website/index.html`. First slice done; polygon footprints and PostGIS write-back are follow-ups. See `poi_editor.md`.
