...
11. [ ] Work the code-health remediation pass: `../03_event_app/code_health_pass_4.md`, continuing from `_done/code_health_pass.md`. CSS top-to-bottom, theme review, and adjacent code smells from Sprint 02 carryover.
