...
> sprint's slate (slices 1–8) closed to `../_done/13_viewer_extraction/_done/`. This is
...
The `?tester=1` surface (shipped in `../_done/13_viewer_extraction/_done/viewer_locate_install_version.md`)
...
- `../_done/13_viewer_extraction/_done/viewer_locate_install_version.md` — the `?tester=1` surface + the
  reserved FAB slot + the `.tester` hook.
- `../_done/13_viewer_extraction/_done/viewer_swap.md` — the swap that made the read viewer `index.html`.
