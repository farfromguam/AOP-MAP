...
| Left hot button | Everyone on-site during an event | Jump to the live need | Candidate: "Now" or "Event HQ" rather than a generic icon | Decide action before icon. Fire icon only works if it means live event / what's hot now |
