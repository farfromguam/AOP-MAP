...
- *"our region circle callouts need to be positionable"* — consumes the shared "find + move" primitive built in `poi_editor_v2.md`. Adopt the primitive on the `visitor-context` label anchors instead of writing a parallel drag handler. Extends `../01_mvp/visitor_context_callouts.md`.
...
- `02_edit/poi_editor_v2.md` — Bucket G. **Written.**
