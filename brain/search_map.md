...
- data maturity, gold data, silver, tier, locked data, unlock to edit, `_meta.maturity`, `stamp_maturity.py`, gold/silver editor sections, maturity badge, which data is gold, do-not-gold: `research/data_maturity_tiers.md`, then `mvp/scripts/stamp_maturity.py`, then `tasks/04_event_app/editor_unified_dock.md`
